    ...
    async execute(client, message, args) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setAuthor({
                    name: `${client.config.botName} • Channel Locked`,
                    iconURL: client.user.displayAvatarURL()
                })
                .setDescription(`
${client.config.emojis.success} **Channel Locked Successfully**
...
`)
            ...
            return message.reply({
                content: `${client.config.emojis.error} Failed to lock this channel.`
            });
